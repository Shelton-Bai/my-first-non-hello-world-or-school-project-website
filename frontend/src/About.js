function About() {
	return (
		<div className="flex flex-col text-2xl w-full px-16 leading-loose whitespace-pre-wrap">
			<h1 className="text-4xl emphasis">About This Website:</h1>
			<p>
				...
				{"\n\t"}I'm not the best graphic designer, so the website probably looks a bit amateurish, but I did my best to make it somewhat
				presentable.
			</p>
			<h1 className="text-4xl emphasis">About Me:</h1>
			<p>
