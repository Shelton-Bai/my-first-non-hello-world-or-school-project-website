...
function Home({toggleTheme}) {
	...
	return (
		<div className="flex flex-col text-2xl w-full px-16 leading-loose">
			<h1 className="self-center text-6xl mt-12 mb-2 tracking-wider font-medium text-center">Shelton's Site</h1>
			<p className='self-center text-center mb-6 w-2/3'>
				This is a website I built mostly to showcase some of my skills, but also because I was bored of LeetCode and needed to 
				do something "productive".
			</p>
			<h2 className='text-4xl py-6'>"What are you using this website for?" <span className='text-xl'>- you, probably</span></h2>

			<ul className='py-2 px-4'>
				<li className="text-3xl"><u>To show off to employers</u></li>
					<div className='px-4'>
				...
				<li className="text-3xl"><u>Any miscellaneous hobbies I might have</u></li>
					<div className='px-4'>
				...
				<li className="text-3xl"><u>I gotta do <i>something</i> with my Oracle Cloud instance</u></li>
					<div className='px-4'>
